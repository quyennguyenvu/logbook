...
var a = y(require("obsidian")),
  ...
  b = class extends a.PluginSettingTab {
    ...
    display() {
      ...
      l.createEl("div", { text: "Color scheme", cls: "setting-item-name" })
      let d = l.createEl("div", { cls: "setting-item-description" })
      d.appendChild(
        createEl("span", { text: "To create a custom color scheme use the " })
      ),
        d.appendChild(
          createEl("a", {
            text: "Style Settings",
      ...
      let t = () => {
          ...
          this.app.vault.getConfig("foldHeading")
            ? ((this.settings.folding = !0),
              ...
              (e = !0))
            : ((this.settings.folding = !1), console.log("Folding is off")),
