...
function getDailyNotesPlugin() {
  ...
  return (_a = internalPlugins.getPluginById("daily-notes")) === null ||
    _a === void 0
    ? void 0
    : _a.instance
}
...
function hasLegacyDailyNoteSettings() {
  ...
  const options =
    (_a = getDailyNotesPlugin()) === null || _a === void 0 ? void 0 : _a.options
...
function getLegacyDailyNoteSettings() {
  ...
  return {
    ...
    folder:
      (_a = options.folder) === null || _a === void 0 ? void 0 : _a.trim(),
    template:
      (_b = options.template) === null || _b === void 0 ? void 0 : _b.trim(),
  }
}
...
function getLegacyWeeklyNoteSettings() {
  ...
  return {
    ...
    folder:
      ((_a = options.weeklyNoteFolder) === null || _a === void 0
        ? void 0
        : _a.trim()) || "",
    template:
      ((_b = options.weeklyNoteTemplate) === null || _b === void 0
        ? void 0
        : _b.trim()) || "",
  }
}
    ...
    },
    {
      ...
      checkCallback: (checking) => {
        if (checking) {
          const activeFile = getActiveFile()
          return !!(
            activeFile && getDateFromFile_1(activeFile, config.unitOfTime)
          )
        }
...
function add_css$1() {
  ...
  style.textContent =
    ".check.svelte-1q3q9tf{margin-left:6px;width:12px;height:12px}"
...
function create_if_block_3(ctx) {
  ...
  function select_block_type(ctx, dirty) {
    if (/*$settings*/ ctx[5].hasMigratedDailyNoteSettings)
    ...
    m(target, anchor) {
      ...
      if (!mounted) {
        dispose = listen(button, "click", function () {
          if (is_function(/*migrateDailyNoteSettings*/ ctx[2]))
            /*migrateDailyNoteSettings*/ ctx[2].apply(this, arguments)
        })
...
function create_fragment$4(ctx) {
  ...
  let if_block2 =
    !(/*hasDailyNoteSettings*/ ctx[3]) &&
    !(/*hasWeeklyNoteSettings*/ ctx[4]) &&
    create_if_block$4()
  ...
  return {
    ...
    m(target, anchor) {
      ...
      if (!mounted) {
        dispose = listen(button, "click", function () {
          if (is_function(/*handleTeardown*/ ctx[1]))
            /*handleTeardown*/ ctx[1].apply(this, arguments)
        })
...
function instance$4($$self, $$props, $$invalidate) {
  let $settings,
    ...
    $$subscribe_settings = () => (
      ...
      ($$unsubscribe_settings = subscribe(settings, ($$value) =>
  ...
  $$self.$$set = ($$props) => {
    if ("settings" in $$props)
      $$subscribe_settings($$invalidate(0, (settings = $$props.settings)))
    if ("handleTeardown" in $$props)
      $$invalidate(1, (handleTeardown = $$props.handleTeardown))
    if ("migrateDailyNoteSettings" in $$props)
      $$invalidate(
        2,
        (migrateDailyNoteSettings = $$props.migrateDailyNoteSettings)
      )
  }
...
function create_fragment$3(ctx) {
  ...
  let b
  let t5_value =
    window.moment().format(/*value*/ ctx[2] || /*defaultFormat*/ ctx[8]) + ""
  let t5
  let t6
  let t7
  let t8
  ...
  return {
    ...
    m(target, anchor) {
      ...
      set_input_value(
        input,
        /*$settings*/ ctx[3][/*periodicity*/ ctx[1]].format
      )
    ...
    p(ctx, [dirty]) {
      if (
        ...
        t5_value !==
          (t5_value =
            window
              .moment()
              .format(/*value*/ ctx[2] || /*defaultFormat*/ ctx[8]) + "")
      )
      ...
      if (
        dirty & /*$settings, periodicity*/ 10 &&
        input.value !== /*$settings*/ ctx[3][/*periodicity*/ ctx[1]].format
      ) {
        set_input_value(
          input,
          /*$settings*/ ctx[3][/*periodicity*/ ctx[1]].format
...
function instance$3($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props) => {
    if ("settings" in $$props)
      $$subscribe_settings($$invalidate(0, (settings = $$props.settings)))
    if ("periodicity" in $$props)
      $$invalidate(1, (periodicity = $$props.periodicity))
  }
...
class FolderSuggest extends TextInputSuggest {
  getSuggestions(inputStr) {
    ...
    abstractFiles.forEach((folder) => {
      if (
        folder instanceof obsidian.TFolder &&
...
function create_fragment$2(ctx) {
  ...
  return {
    ...
    m(target, anchor) {
      ...
      set_input_value(
        input,
        /*$settings*/ ctx[2][/*periodicity*/ ctx[1]].template
      )
    ...
    p(ctx, [dirty]) {
      if (
        dirty & /*periodicity*/ 2 &&
        t0_value !== (t0_value = capitalize(/*periodicity*/ ctx[1]) + "")
      )
      ...
      if (
        dirty & /*$settings, periodicity*/ 6 &&
        input.value !== /*$settings*/ ctx[2][/*periodicity*/ ctx[1]].template
      ) {
        set_input_value(
          input,
          /*$settings*/ ctx[2][/*periodicity*/ ctx[1]].template
...
function create_fragment$1(ctx) {
  ...
  return {
    ...
    m(target, anchor) {
      ...
      set_input_value(
        input,
        /*$settings*/ ctx[2][/*periodicity*/ ctx[1]].folder
      )
    ...
    p(ctx, [dirty]) {
      ...
      if (
        dirty & /*$settings, periodicity*/ 6 &&
        input.value !== /*$settings*/ ctx[2][/*periodicity*/ ctx[1]].folder
      ) {
        set_input_value(
          input,
          /*$settings*/ ctx[2][/*periodicity*/ ctx[1]].folder
  ...
  return {
    ...
    p(ctx, dirty) {
      ...
      if (dirty & /*$settingsStore*/ 1)
        gettingstartedbanner_changes.handleTeardown = /*func*/ ctx[6]
...
function create_each_block(ctx) {
  ...
  let if_block =
    /*$settingsStore*/ ctx[0][/*periodicity*/ ctx[9]].enabled &&
    create_if_block(ctx)
...
function create_fragment(ctx) {
  ...
  let current
  let if_block =
    /*$settingsStore*/ ctx[0].showGettingStartedBanner && create_if_block_1(ctx)
  ...
  return {
    ...
    p(ctx, [dirty]) {
      ...
      if (
        dirty & /*periodicities, settingsStore, $settingsStore, capitalize*/ 11
      ) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  component_subscribe($$self, settingsStore, (value) =>
    $$invalidate(0, ($settingsStore = value))
  )
  ...
  function migrateDailyNoteSettings() {
    ...
    settingsStore.update((old) =>
      Object.assign(Object.assign({}, old), {
        daily: Object.assign(Object.assign({}, dailyNoteSettings), {
          enabled: true,
        }),
  ...
  $$self.$$set = ($$props) => {
    ...
    if ("onUpdateSettings" in $$props)
      $$invalidate(5, (onUpdateSettings = $$props.onUpdateSettings))
  }
...
class PeriodicNotesPlugin extends obsidian.Plugin {
  ...
  migrateWeeklySettings() {
    ...
    this.updateSettings(
      Object.assign(Object.assign({}, this.settings), {
        weekly: Object.assign(Object.assign({}, calendarSettings), {
          enabled: true,
        }),
